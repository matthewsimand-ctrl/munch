  ...
  return (
    <span className={`inline-flex items-center gap-1.5 text-white text-xs font-bold px-2 py-0.5 rounded-full ${tone} ${className}`}>
      ...
      <span className="relative group inline-flex">
        ...
        <span className="pointer-events-none absolute z-20 hidden group-hover:block -right-1 bottom-full mb-1 w-52 rounded-md bg-gray-900 px-2 py-1.5 text-[10px] font-medium text-white leading-tight shadow-lg">
